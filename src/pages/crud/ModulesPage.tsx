...
export default function ModulesPage() {
  ...
  return (
    <Stack gap="xl">
      <Paper p="lg" radius="lg" withBorder style={{ borderColor: "var(--mantine-color-orange-2)", background: "linear-gradient(135deg, var(--mantine-color-default) 0%, var(--mantine-color-orange-0) 100%)" }}>
